...
{
    const { setSelectedLevel } = useContext(WorkoutContext)
            ...
            <form>
                <div className="Choose_Text">
                  <section>
                     ...
                     <br></br>       
                     <br></br>     
                     <input type="radio" id="Beginner" name="Choose_Level" value="1" onChange={() => setSelectedLevel(1)} required/>
                     <label htmlFor="Beginner" title="Choose this if you are new and want to do Calisthenics">Beginner</label>
                     <br></br>           
                     <br></br> 
                     <input type="radio" id="Intermediate" name="Choose_Level" value="2" onChange={() => setSelectedLevel(2)} required/>
                     ...
                     <br></br>           
                     <br></br> 
                     <input type="radio" id="Advanced" name="Choose_Level" value="3" onChange={() => setSelectedLevel(3)} required/>
